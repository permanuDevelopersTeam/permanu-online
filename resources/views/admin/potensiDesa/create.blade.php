...
<div class="flex flex-col justify-center items-center p-5 mb-5">
  <h1 class="text-[40px] text-gray-400 monserrat font-bold">TAMBAH DATA POTENSI</h1>
</div>

<div class="p-16 flex justify-center">
  <div class="w-[80%]">
    <form action="{{ route('admin.potential.store') }}" method="post" class="w-full" enctype="multipart/form-data">
      @csrf
      ...
      <div>
        ...
        <select name="typePotentialUuid" id="typePotentialUuid" class="mb-3 w-full rounded-lg border p-3 @error('typePotentialUuid') border-red-400 @enderror">
          <option selected disabled> - Pilih Tipe Potensi - </option>
