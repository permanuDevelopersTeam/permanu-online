...
<div class="flex flex-col justify-center items-center p-5 mb-5">
  <h1 class="text-[40px] text-gray-400 monserrat font-bold">BUAT GALLERY</h1>
</div>

<div class="p-16 flex justify-center">
  <div class="w-[80%]">
    <form action="{{ route('admin.gallery.store') }}" method="post" class="w-full" enctype="multipart/form-data">
      @csrf
      <!-- Input Title -->
      <div class="mb-5">
      ...
      @for($i = 1; $i <= 9; $i++)
        ...
        <img class="img-preview img-preview-{{ $i }} w-full h-[260px] border rounded-lg mb-3 object-cover">
